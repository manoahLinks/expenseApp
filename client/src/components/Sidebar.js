...
const Sidebar = () => {
    ...
    return ( 
        <div className='w-2/12 border-r fixed h-full grid grid-cols-1 hidden md:block bg-gray-50'>
            ...
            <div className="flex flex-col gap-y-2 mt-5 mx-10 ">
                <Link onClick={()=> {setActiveTab(1)}} className={`${activeTab == 1 ? `bg-primary bg-opacity-10` : `bg-white`} flex gap-x-4 items-center p-2 rounded hover:bg-primary hover:bg-opacity-20`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
                        <path fillRule="evenodd" d="M4.25 2A2.25 2.25 0 002 4.25v2.5A2.25 2.25 0 004.25 9h2.5A2.25 2.25 0 009 6.75v-2.5A2.25 2.25 0 006.75 2h-2.5zm0 9A2.25 2.25 0 002 13.25v2.5A2.25 2.25 0 004.25 18h2.5A2.25 2.25 0 009 15.75v-2.5A2.25 2.25 0 006.75 11h-2.5zm9-9A2.25 2.25 0 0011 4.25v2.5A2.25 2.25 0 0013.25 9h2.5A2.25 2.25 0 0018 6.75v-2.5A2.25 2.25 0 0015.75 2h-2.5zm0 9A2.25 2.25 0 0011 13.25v2.5A2.25 2.25 0 0013.25 18h2.5A2.25 2.25 0 0018 15.75v-2.5A2.25 2.25 0 0015.75 11h-2.5z" clipRule="evenodd" />
                    </svg>
                    <h4>Dashboard</h4>
                </Link>
                <Link onClick={()=> {setActiveTab(2)}} className={`${activeTab == 2 ? `bg-primary bg-opacity-10` : `bg-white`} flex gap-x-4 items-center p-2 rounded hover:bg-primary hover:bg-opacity-20`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
                        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-5.5-2.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zM10 12a5.99 5.99 0 00-4.793 2.39A6.483 6.483 0 0010 16.5a6.483 6.483 0 004.793-2.11A5.99 5.99 0 0010 12z" clipRule="evenodd" />
                    </svg>
                    <h4>My Profile</h4>
                </Link>
                <Link onClick={()=> {setActiveTab(3)}} to={`/dbar`} className={` ${activeTab == 3 ? `bg-primary bg-opacity-10` : `bg-white`} flex gap-x-4 items-center p-2 rounded hover:bg-primary hover:bg-opacity-20`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
                ...
                <Link onClick={()=> {setActiveTab(4)}} className={`${activeTab == 4 ? `bg-primary bg-opacity-10` : `bg-white`} flex gap-x-4 items-center p-2 rounded hover:bg-primary hover:bg-opacity-20`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
                ...
                <Link onClick={()=> {setActiveTab(5)}} className={`${activeTab == 5 ? `bg-primary bg-opacity-10` : `bg-white`} flex gap-x-4 items-center p-2 rounded hover:bg-primary hover:bg-opacity-20`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
