const AlertBox = ({message}) => {
    return ( 
        <div className="flex flex-col inset-0 fixed m-2">
            <div className="flex items-center p-2 rounded-lg border border-purple-800 bg-purple-200 bg-opacity-80 text-purple-800">
