const AccountTransactions = () => {
    return ( 
        <div className="grid grid-cols-1 inset-0 fixed bg-primary bg-opacity-20 justify-center items-center justify-items-center">
            <div className="flex flex-col md:w-4/12 gap-y-6 bg-white rounded-lg md:p-5 p-3">
                ...
                <div className="flex flex-col md:gap-y-8 gap-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-x-4">
                        <button className="flex items-center gap-x-2 p-1 border rounded border-slate-300">
                ...
                <div className="flex flex-col gap-y-4">
                    <div className="grid grid-cols-4 text-center cursor-pointer border-b">
                        <h4>View All</h4>
                        <h4>Transactions</h4>
                        <h4>Deposit</h4>
                        <h4>Transfer</h4>
