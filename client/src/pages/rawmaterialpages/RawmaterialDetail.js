...
const RawmaterialDetail = ({modalOff, id}) => {
    ...
    return ( 
        <div className="grid grid-cols-1 md:grid-cols-4 fixed inset-0 bg-gray-400  bg-opacity-20">
            <div>
            ...
            <div className="flex flex-col modal gap-y-4 md:col-span-2 bg-white p-5">
                <div className="grid grid-cols-3">
                    ...
                    <h4 className="text-green-700 col-span-2">Raw-material Details</h4>
                </div>
                ...
                <form  className="grid grid-cols-1 gap-y-4 md:gap-x-8">
                    ...
                    <div className="grid grid-cols-3 gap-x-4 mt-2 md:mt-5">
                        <button onClick={modalOff} className="border md:p-2 rounded border-green-700 text-green-700 p-1">cancel</button>
                        <button className="rounded p-1 md:p-2 bg-green-700 text-white col-span-2">submit</button>
                    </div>
                </form>
            </div>
