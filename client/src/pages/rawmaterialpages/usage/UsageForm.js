    ...
    return ( 
        <div className="grid grid-cols-1 inset-0 fixed bg-primary bg-opacity-10 justify-items-center text-xs">
            ...
            <div className="">
                ...
                <form className="grid grid-cols-1 gap-y-2 bg-white rounded-md shadow p-5">
                    ...
                    <div className="flex flex-xol gap-x-2 mt-4">
                        <button className={`p-2 rounded bg-error text-red-500 hover:bg-red-500 hover:text-error`}>close</button>
