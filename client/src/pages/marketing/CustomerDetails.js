...
const CustomerDetails = ({modalOff, customer}) => {
    ...
    return ( 
        <div className="grid h-screen  grid-cols-1 md:grid-cols-4 fixed inset-0 bg-primary bg-opacity-20">
            <div>

            </div>
            <div className="flex flex-col md:my-16 md:col-span-2 bg-white p-5 gap-y-8 modal">
                <div className="grid grid-cols-3 text-green-700">
                    <div className="flex rounded-full" onClick={modalOff}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"  strokeWidth={2.5} fill="currentColor" className="w-5 h-5 md:w-8 md:h-8">
                            <path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z" />
                        </svg>
                    </div>
                    <h4 className="text-sm col-span-2">Customer Details</h4>
                </div>
                ...
                <form className="grid grid-cols-1 gap-y-4">
                    <div className="flex flex-col">
                        ...
                        <input 
                            type="text"
                            className="border-none text-xs p-2 rounded bg-gray-50 md:text-sm"
                        />
                    </div>
                    <div className="grid text-green-700 gap-x-2 gap-y-2 md:gap-x-4 md:gap-y-4 grid-cols-2">
                        <div className="grid grid-cols-1">
                            <label className="text-green-700 gap-x-2 flex" >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-3 h-3 md:w-5 md:h-5">
                            ...
                            <input 
                                type="email"
                                className="p-2 border-none rounded text-xs bg-gray-50 md:text-sm"
                            />
                        </div>
                    ...
                    <div className="flex flex-col text-green-700">
                        ...
                        <input 
                            type="text"
                            className="border-none p-2 rounded text-xs bg-gray-50 md:text-sm"
                        />
                    </div>
                    <div className="grid grid-cols-3 gap-x-4 mt-2">
                        <button onClick={modalOff} className="border rounded border-green-700 text-green-700 p-1 md:p-2">cancel</button>
                        <button className="rounded p-1 bg-green-700 text-white col-span-2 md:p-2">submit</button>
                    </div>
                </form>
            </div>
        </div>
