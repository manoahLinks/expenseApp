                ...
                <div className="flex justify-between">
                    ...
                    <div className="flex">
                        <span onClick={()=>{handleClick(3)}} className="flex bg-orange-300 text-orange-900 font-semibold items-center gap-x-2 p-1 text-white rounded-md">
                            ...
                            <small>send an order</small>
                        </span>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:p-5 border bg-slate-100 rounded-lg">
                        <p>Orders can be sent and managed here, any product created can be used for slaes and production purposes and records are properly documented </p>
                </div>
            </div>
