...
const SalesPage = () => {
    ...
    return ( 
        <div className="flex flex-col gap-y-4">
            <div className='md:p-3 p-2 text-xs bg-white shadow w-auto md:justify-evenly md:overflow-x-hidden overflow-x-scroll flex items-center md:gap-y-2 gap-x-1'>
                <span onClick={()=>{handleClick(1)}} className={`whitespace-nowrap ${activeTab === 1 ? `shadow-[inset_-2px_-2px_5px_rgba(255,255,255,0.7),inset_3px_3px_5px_rgba(0,0,0,0.1)]` :``} shadow-[-2px_-2px_10px_rgba(255,255,255,1),3px_3px_10px_rgba(0,0,0,0.2)] cursor-pointer px-2 py-1 justify-center rounded flex gap-x-2`}>
