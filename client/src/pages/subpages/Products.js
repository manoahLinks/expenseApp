...
const Products = () => {
    ...
    return ( 
        <div className="flex flex-col gap-y-4">
            <div className='md:p-3 p-2 text-xs bg-white md:justify-evenly flex w-auto overflow-x-scroll md:overflow-x-hidden modal shadow items-center md:gap-y-2 gap-x-1 border-b'>
                <span onClick={()=>{handleClick(1)}} className={`whitespace-nowrap ${activeTab === 1 ? `bg-primary text-white` : ``} cursor-pointer px-2 hover:bg-primary hover:text-white py-1 justify-center border rounded flex gap-x-2`}>
