...
const Products = () => {
    ...
    return ( 
        <div className="flex flex-col">
            <div className="grid grid-cols-1 p-2 bg-white">
                <div className='flex items-center overflow-x-scroll md:overflow-x-hidden'>
                    ...
                    <span onClick={()=>{handleClick(3)}} className={`flex p-2 ${activeTab === 3 ? `border-b-2 border-green-400` : ``} p-2 whitespace-nowrap border-b-2 cursor-pointer`}>
