        ...
        <div className="flex flex-col">
            <div className="flex justify-between md:overflow-x-hidden overflow-x-scroll p-3 bg-white">
                ...
                <div className="flex justify-end md:gap-x-4 gap-x-2">
                    <span className="flex items-center whitespace-nowrap gap-x-2 border border-slate-200 py-1 px-2 rounded-lg">
                    ...
                    <span onClick={()=>{handleClick(3)}} className="flex items-center whitespace-nowrap gap-x-2 border border-slate-200 py-1 px-2 rounded-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-5 h-5">
