        ...
        <div className="flex flex-col">
            <div className="flex justify-between md:overflow-x-hidden overflow-x-scroll p-3 bg-white">
                ...
                <div className="flex justify-end md:gap-x-4 gap-x-2">
                    <span onClick={()=>{setUserInvitePage(true)}} className="cursor-pointer flex items-center whitespace-nowrap gap-x-2 border py-1 px-2 rounded-md">
                    ...
                    <span onClick={()=>{handleClick(3)}} className="cursor-pointer flex items-center text-white bg-gray-700 font-bold whitespace-nowrap gap-x-2 py-1 px-2 rounded-md">
                    ...
                    <span onClick={()=>{handleClick(2)}} className="cursor-pointer flex items-center whitespace-nowrap gap-x-2 border border-slate-200 py-1 px-2 rounded-lg">
