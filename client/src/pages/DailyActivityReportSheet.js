            ...
            <div className='p-2 overflow-x-auto justify-evenly text-xs border-b flex items-center gap-x-1'>
                ...
                <span onClick={()=>{handleClick(1)}} className={`${ activeTab == 1 ? `bg-primary text-white` : `bg-white`} md:p-2 hover:bg-primary font-semibold hover:text-white hover:font-semibold p-1 items-center border rounded flex gap-x-2`}>
                    ...
                    <h4 className="">Production</h4>
                        ...
                        <span onClick={()=>{handleClick(2)}} className={`${ activeTab == 2 ? `bg-primary text-white` : `bg-white`} md:p-2 hover:bg-primary font-semibold hover:text-white hover:font-semibold p-1 items-center border rounded flex gap-x-2`}>
                ...
                <span onClick={()=>{handleClick(3)}} className={`${ activeTab == 3 ? `bg-primary text-white` : `bg-white`} md:p-2 hover:bg-primary font-semibold hover:text-white hover:font-semibold p-1 items-center border rounded flex gap-x-2`}>
                    ...
                    <span onClick={()=>{handleClick(4)}} className={`${ activeTab == 4 ? `bg-primary text-white` : `bg-white`} md:p-2 hover:bg-primary font-semibold hover:text-white hover:font-semibold p-1 items-center border rounded flex gap-x-2`}>
                ...
                <span onClick={()=>{handleClick(5)}} className={`${ activeTab == 5 ? `bg-primary text-white` : `bg-white`} md:p-2 hover:bg-primary font-semibold hover:text-white hover:font-semibold p-1 items-center border rounded flex gap-x-2`}>
