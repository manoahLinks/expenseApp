    ...
    return ( 
        <div className="flex flex-col">
            <div className='p-2 overflow-x-auto justify-evenly text-xs border-b flex items-center gap-x-1'>
                <span onClick={()=>{handleClick(0)}} className={`cursor-pointer ${ activeTab == 0 ? `bg-primary text-white` : `bg-white`} md:p-2 hover:bg-primary font-semibold hover:text-white hover:font-semibold p-1 items-center border rounded flex gap-x-2`}>
