    ...
    return ( 
        <div className="grid grid-cols-1 bg-gradient-to-r from-violet-500 to-fuchsia-500 items-center fixed inset-0">
            ...
            <div className="flex flex-col border border-slate-200 p-5 m-2 gap-y-4 bg-white md:w-4/12 md:mx-auto shadow-lg rounded-md">
                <h4 className="text-primary font-semibold">Password recovery</h4>
                <form className="grid grid-cols-1 gap-y-4">
                    ...
                    />
                    <button className="bg-gradient-to-r from-violet-500 to-fuchsia-500 p-2 mt-5 rounded text-white font-bold">send recovery email</button>
                </form>
