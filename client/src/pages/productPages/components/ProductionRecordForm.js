...
const ProductionRecordForm = ({modalOff}) => {
    ...
    return ( 
        <div className="grid grid-cols-1 items-center justify-center overflow-y-scroll justify-items-center inset-0 fixed bg-primary bg-opacity-20">
            <div className="flex flex-col md:gap-y-4 gap-y-2 md:p-5 p-2 bg-white md:w-4/12 w-full rounded-lg">
