            ...
            <table className="table-auto w-full text-xs text-center">
                ...
                <tbody className="">
                    {suppliers && suppliers.map((supplier)=>(
                        <tr key={supplier._id} className="border-b hover:bg-primary hover:bg-opacity-20 grid grid-cols-7">
                            <td onClick={()=>{modalOn(supplier)}}  className="px-4 py-2 bg-primary bg-opacity-50 text-white font-semibold">{supplier.name}</td>
                            ...
                            <td onClick={()=>{handleDelete(supplier._id)}} className="px-4 py-2">
