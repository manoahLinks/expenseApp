    ...
    return ( 
        <div className="grid grid-cols-1 items-center">
            <div className="grid grid-cols-3 md:grid-cols-6 gap-x-2 gap-y-2 md:gap-x-4 p-2">
                ...
                <Link to={`/rawmaterials`} className="hover:bg-gray-200 shadow-md flex flex-col gap-y-2 items-center rounded-md p-2">
                    {<img src={require(`../assets/icons8-wheat-48.png`)} alt="" />}
                    <h4 className="text-center md:text-sm font-semibold">Raw Materials</h4>
                </Link>
                <Link to={`/products`} className="hover:bg-gray-200 shadow-md flex flex-col gap-y-2 items-center rounded-md p-2">
                ...
                <Link to={`/finance`} className="hover:bg-green-200 shadow-md flex flex-col gap-y-2 items-center rounded-md p-2">
