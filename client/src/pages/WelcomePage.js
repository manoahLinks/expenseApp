...
const WelcomePage = () => {
    return ( 
        <div className="h-screen flex flex-col bg-purple-100 gap-y-2 items-center justify-center">
           ...
           <h4 className='p-3 text-center font-light text-purple-900 text-xl'>Fund account and make expenditures on the go !</h4>
